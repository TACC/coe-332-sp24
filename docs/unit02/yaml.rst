...
.. note::
   ...
   `here <https://raw.githubusercontent.com/tacc/coe-332-sp24/main/docs/unit02/sample-data/Meteorite_Landings.yaml>`_.
...
.. warning::
   ...
   .. code-block:: console
      ...
      [student-login]$ pip3 install --user pyyaml


Given the meteorite landing site data in YAML format, which you can download from
`this link <https://raw.githubusercontent.com/tacc/coe-332-sp24/main/docs/unit02/sample-data/Meteorite_Landings.yaml>`_,
